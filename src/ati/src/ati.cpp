...
int main(int  argc, char **argv) 
{
	...
	ros::NodeHandle nh;
	ros::Publisher pub_force=nh.advertise<force_msg::Force>("/force_msg",1000);
    force_msg::Force force_data;
	...
	while(ros::ok())
	{
	   ...
	   force_msg::Force force_data;
	   force_data.force_x.push_back(resp.FTData[0]);
	   force_data.force_y.push_back(resp.FTData[1]);
	   force_data.force_z.push_back(resp.FTData[2]);
